...
import type { Project, Milestone, MilestoneType } from '@/features/projects/types';
...
export default function ProjectMilestonesTimeline({ project, milestones: initialMilestones = [], milestoneTypes = [], onComplete, readOnly = false }: ProjectMilestonesTimelineProps) {
    ...
    const getMilestoneStyle = (milestone: any) => {
